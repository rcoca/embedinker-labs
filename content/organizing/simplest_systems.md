---
title: "Simplest organizing systems"
...
tags:
  - task-management
  - hierarchical-data
description: A walkthrough over simplest organizing systems - and rationale
series: "Organizing Systems"
slug: simplest-organizing-systems
distribution:
  linkedin:
    status: pending
    payload_snippet: Walkthrough simplest organizing systems
    link_posted: ""
  reddit:
    status: pending
    target_subreddits:
  ...
  grimm_network:
    ...
    thread_id: ""
---
## As simple as you need to - but not simpler

Organizing system is a process running in the background - while you try to accomplish real work. It's supposed to help - not require full attention. It should be able to degrade gracefully under pressure and chaos - and recover later easily.


## Ad-hoc method: Low/High Watermarks
The setup is that you don't really have enough time for a *Mind Dump* - nor walk a full GTD system and reviews. But you want to keep things together and remain in control. At least apparently.
One easy way is to keep a running list of areas - and mark them with one of 3 labels: 
...
It will move you - over a span of a few minutes - in a state with all current commitments addressed and accounted for - and a plan to move forward. 
It's only natural to maintain more than one project - to also mitigate the risk of a single big project failing.
